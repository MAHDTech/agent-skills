...
The general Spec-and-Standards review is not backlog-specific, so **delegate it to the [code-review](../../../skills/review/code-review/SKILL.md) skill** rather than restating it here. Run that review - either inline, or in a subagent working in the spoke's existing clone - and pass it:
...
- [code-review](../../../skills/review/code-review/SKILL.md) - the general dual-axis (Spec and Standards) review that this skill delegates to.
