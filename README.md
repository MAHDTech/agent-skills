...
- **[tars-backlog-prepare](skills/planning/tars-backlog-prepare/SKILL.md)** — Prepare to run the tars-backlog-loop by cleaning up orphaned git worktrees and branches, and ensuring the working tree is clean. Reach for this to reset the environment before starting a full backlog loop.
