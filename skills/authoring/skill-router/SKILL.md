...
- [/tars-backlog-prepare](../../planning/tars-backlog-prepare/SKILL.md) — reach for this to reset the environment before starting a full backlog loop, verifying shared git integrity, resolving the isolated spoke workspace root, and cleaning up orphaned workspaces and branches.
