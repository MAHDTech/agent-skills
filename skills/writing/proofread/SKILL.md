...
> Boundary: proofread is error-correction for a publishable post - fixing spelling, grammar, repetition, and logic while preserving the author's voice. For a structural rewrite of reference or technical docs (reordering, quickstart-first, trimming to the shortest path), reach for documentation simplification instead.
