...
- [backlog-create-issue](../../planning/backlog-create-issue/SKILL.md) — canonical format and standards for backlog issues.
- [backlog-implement](../../engineering/backlog-implement/SKILL.md) — implementation phase that dispatches tasks to spokes.
- [backlog-loop](../../planning/backlog-loop/SKILL.md) — orchestration of the full backlog pipeline.
