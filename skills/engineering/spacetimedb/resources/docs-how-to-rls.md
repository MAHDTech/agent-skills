...
For access control, **use [Views](/docs/functions/views) instead**.
Views provide:
...
Control](/docs/tables/access-permissions#using-views-for-fine-grained-access-control)
...
requesting client's [Identity](/docs/intro/key-architecture#identity).
...
docs](/docs/reference/sql#subscriptions) do not apply to RLS rules, they
