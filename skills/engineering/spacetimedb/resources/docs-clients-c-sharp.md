...
See [Tables](/docs/tables), [Reducers](/docs/functions/reducers), and
[Column Types](/docs/tables/column-types) for full server-side
...
(See also the [CSharp Quickstart](/docs/quickstarts/c-sharp) for an
...
See [the quickstart](/docs/quickstarts/c-sharp) for examples of
...
[module docs](/docs/intro/key-architecture#identity) for more details.
...
docs](/docs/intro/key-architecture#connectionid) for more details.

### Type `Timestamp`

A point in time, measured in microseconds since the Unix epoch. See the
[module docs](/docs/tables/column-types) for more details.
...
`partial class`. See the [module docs](/docs/tables/column-types) for
more details.
