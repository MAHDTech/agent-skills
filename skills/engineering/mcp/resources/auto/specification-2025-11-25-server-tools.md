...
or data using a suitable [URI scheme](specification-2025-11-25-server-resources.md#common-uri-schemes). Servers that use embedded resources **SHOULD** implement the `resources` capability:
