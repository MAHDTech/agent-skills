...
[initialization](specification-2025-11-25-basic-lifecycle.md#initialization):
...
\<Note\>
  **Important**: URL mode elicitation is *not* for authorizing the MCP client's
  ...
  authorization](specification-2025-11-25-basic-authorization.md)). Instead, it's used when the MCP
...
* For remote MCP servers, user identification **MUST** be derived from credentials acquired via [MCP authorization](specification-2025-11-25-basic-authorization.md) when possible (e.g. `sub` claim)
...
Authorization with external APIs enabled by URL mode elicitation is separate from [MCP authorization](specification-2025-11-25-basic-authorization.md). MCP servers **MUST NOT** rely on URL mode elicitation to authorize users for themselves.

#### Understanding the Distinction

* **MCP Authorization**: Required OAuth flow between the MCP client and MCP server (covered in the [authorization specification](specification-2025-11-25-basic-authorization.md))
...
* Correct: Rely on [authorization](specification-2025-11-25-basic-authorization.md) to identify the user
...
Typically identity verification is done by leveraging the [MCP authorization server](specification-2025-11-25-basic-authorization.md) to identify the user, through a session cookie or equivalent in the browser.
