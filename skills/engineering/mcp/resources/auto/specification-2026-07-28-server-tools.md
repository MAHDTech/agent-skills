...
or data using a suitable [URI scheme](specification-2026-07-28-server-resources.md#common-uri-schemes). Servers that use embedded resources **SHOULD** implement the `resources` capability:
