...
For more details about server primitives see [server concepts](docs-draft-learn-server-concepts.md).
...
For more details about client primitives see [client concepts](docs-draft-learn-client-concepts.md).
