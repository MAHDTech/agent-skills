...
or data using a suitable [URI scheme](specification-draft-server-resources.md#common-uri-schemes). Servers that use embedded resources **SHOULD** implement the `resources` capability:
