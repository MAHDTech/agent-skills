...
Apply the checklist for the detected framework (Flutter, React/Next.js, Node.js, Python) from [resources/framework-checklists.md](resources/framework-checklists.md#framework-specific-optimizations).
...
Apply the checklist for the chosen deployment target (TestFlight, Google Play, Web, or Container) from [resources/framework-checklists.md](resources/framework-checklists.md#deployment-preparation).
