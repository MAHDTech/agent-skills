...
1. **Implement.** Work through the spec or tickets. Use test-driven development wherever it fits, at pre-agreed seams: write the failing test, make it pass, refactor.
