...
#1 Tau Voice Leaderboard Sub-second latency 25+ languages$0.05 / min
...
*   Expressive, natural voices across 25+ languages
...
Clone a voice from a short recording and use it instantly across Grok Text to Speech and Speech to Speech APIs.

*   Clone from two minutes of natural speech
...
Natural speech from text across 25+ voices
...
## Expressive voices across 25+ languages
...
[Pricing Docs](https://docs.x.ai/developers/pricing#voice-api-pricing)
...
Talk with SpaceXAI about onboarding, custom limits, and enterprise deployment.

[Contact Sales](https://x.ai/api/voice/contact-us)
