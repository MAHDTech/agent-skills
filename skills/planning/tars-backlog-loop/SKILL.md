...
1. Execute [tars-backlog-prepare](../tars-backlog-prepare/SKILL.md) inline to verify repository integrity, resolve the isolated spoke workspace root, and clean up leftovers from previous runs.
