...
3. The Hub will merge the completed branches back sequentially, run pre-commit checks (using the [prek](../../tooling/prek/SKILL.md) tool) and tests, and move the ticket files to `.tars/issues/done/` or `.tars/issues/failed/`.
