...
For the complete CLI reference, tool and permission details, and agent configuration, see the official OpenCode documentation at [docs.md](resources/docs.md).
