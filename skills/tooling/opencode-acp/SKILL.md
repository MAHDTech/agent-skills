...
- For ACP Protocol Docs (for Agents/LLMs): [Introduction](resources/get-started-introduction.md) and [Protocol Overview](resources/protocol-v1-overview.md)
...
```json
{
  ...
  "params": {
    ...
    "prompt": [{"type": "text", "text": "Your question here"}]
  }
}
```
