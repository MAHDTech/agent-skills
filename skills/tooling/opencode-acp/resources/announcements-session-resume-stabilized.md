...
For the shipped protocol, see [Resuming Sessions](/protocol/v1/session-setup#resuming-sessions). For the design history, see the [Session Resume RFD](/rfds/session-resume).