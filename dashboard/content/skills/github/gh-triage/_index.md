...
- [AGENT-BRIEF.md](@/skills/github/gh-triage/AGENT-BRIEF.md) — how to write durable agent briefs
- [OUT-OF-SCOPE.md](@/skills/github/gh-triage/OUT-OF-SCOPE.md) — how the `.out-of-scope/` knowledge base works
...
5. **Apply the outcome:**
   - `ready-for-agent` — post an agent brief comment ([AGENT-BRIEF.md](@/skills/github/gh-triage/AGENT-BRIEF.md)).
   ...
   - `wontfix` — close, with the comment depending on _why_:
     ...
     - **Rejected (enhancement)** — write to `.out-of-scope/`, link to it from a comment, then close ([OUT-OF-SCOPE.md](@/skills/github/gh-triage/OUT-OF-SCOPE.md)).
