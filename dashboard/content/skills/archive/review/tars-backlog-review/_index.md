...
source_url = "https://github.com/MAHDTech/agent-skills/tree/main/skills-archive/review/tars-backlog-review"
+++
...
The Hub runs this review **after** the verification gate has passed, and before the merge - see [tars-backlog-implement](@/skills/archive/engineering/tars-backlog-implement/_index.md).
...
The general Spec-and-Standards review is not backlog-specific, so **delegate it to the [code-review](@/skills/skills/review/code-review/_index.md) skill** rather than restating it here. Run that review - either inline, or in a subagent working in the spoke's existing clone - and pass it:
...
- [code-review](@/skills/skills/review/code-review/_index.md) - the general dual-axis (Spec and Standards) review that this skill delegates to.
- [tars-backlog-create-issue](@/skills/archive/planning/tars-backlog-create-issue/_index.md) - canonical format and standards for backlog issues.
- [tars-backlog-implement](@/skills/archive/engineering/tars-backlog-implement/_index.md) - implementation phase that dispatches tasks to spokes.
- [tars-backlog-loop](@/skills/archive/planning/tars-backlog-loop/_index.md) - orchestration of the full backlog pipeline.
