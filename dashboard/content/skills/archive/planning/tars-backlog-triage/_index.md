...
source_url = "https://github.com/MAHDTech/agent-skills/tree/main/skills-archive/planning/tars-backlog-triage"
+++


# Backlog Triage

Triage pending issue tickets in `.tars/issues/todo/` (conforming to the template in [tars-backlog-create-issue](@/skills/archive/planning/tars-backlog-create-issue/_index.md)) to verify their accuracy, identify implementation gaps, check for hallucinations, **repair the defects found**, and append a detailed review section to each.
