+++
title = "devenv-reference-environment-variables-index"
[extra]
skill = false
category = "tooling"
mermaid = false
...
- [devenv variables](#devenv-variables) are defined by devenv. The read-only ones are exported into the developer shell so you can reference them from scripts, [tasks](https://devenv.sh/tasks/index.md), and modules. The configurable ones are read by the CLI to change its behavior. Some may mirror and take precedence over a command-line flag.
