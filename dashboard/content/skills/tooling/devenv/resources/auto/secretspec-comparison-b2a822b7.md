...
| Identity and access policy | Uses the credentials available for the selected provider, including [credentials sourced from another provider](https://secretspec.dev/concepts/providers/#provider-credentials) | Enforce users, roles, service identities, policies, and sharing |
