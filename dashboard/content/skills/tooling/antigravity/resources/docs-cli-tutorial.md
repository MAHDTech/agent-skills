...
1. Create a clean project directory and launch the Antigravity TUI
    ...
    text: **First Launch**: If running `agy` for the first time, follow the terminal instructions to complete silent authentication. See [Installation & Auth](/docs/cli/install) for troubleshooting details.
    </Announcement>
