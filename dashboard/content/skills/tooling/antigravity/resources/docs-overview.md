...
Ready to dive in? Check out the **[Getting Started](https://antigravity.google/docs/getting-started)** guide to install Antigravity 2.0 and start your first project.
