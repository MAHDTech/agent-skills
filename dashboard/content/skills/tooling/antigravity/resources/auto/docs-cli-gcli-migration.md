...
profiles. An interactive checklist prompts you to choose which assets to
migrate:
...
- **[Settings, Rendering & Keybindings](https://antigravity.google/docs/cli/settings)**: Customize
  keyboard hotkeys, themes, and screen buffers.
- **[Troubleshooting](https://antigravity.google/docs/cli/troubleshooting)**: Learn how to resolve
