...
For a detailed explanation of baseline quotas, how credits are consumed,
...
- **Statusline Indicator**: The right side of the CLI statusline
  displays your remaining credit count (e.g., `AI Credits: 42`).
- **Low Quota Alert**: When your remaining AI credits drop below the
...
- **Query Balance**: Run the **[AI Credits
  Command](https://antigravity.google/docs/cli/commands/credits)** to open the dedicated credits
  panel. This panel displays your detailed credit usage statistics.
- **Managing Credits**: You can easily purchase AI credits or upgrade
...
- **Use AI Credits Option**: Run `/config` or `/settings` to open the
  CLI settings panel. Set the **Use G1 Credits** field to **on** to
  allow the CLI to use your personal credits when plan quotas are
  exhausted, or set it to **off** to restrict fallback billing. (To
