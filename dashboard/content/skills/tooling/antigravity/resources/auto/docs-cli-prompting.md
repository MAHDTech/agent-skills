...
- **macOS Terminal Fallback**: If using Apple Terminal (which does not
  forward `Shift+Enter` by default), press `Option+Enter`. Ensure you
  check **Use Option as Meta key** in your Terminal Preferences profile.
- **Universal Slash Escape**: Type a trailing backslash `\` at the end
...
- **[Reviewing Artifacts](https://antigravity.google/docs/cli/artifacts)**: Learn to inspect and
  manage file edits, plans, and test executions.
