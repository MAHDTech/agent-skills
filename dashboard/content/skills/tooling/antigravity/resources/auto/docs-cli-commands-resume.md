...
- **Page**: Use ←/→ to page backward and forward through older history
  blocks.
...
2.  Press F2. An input field opens at the bottom of the panel, prefilled
...
4.  Press Enter (or Y) to confirm. The CLI clones the history, context,
    and tool trajectories into your terminal session.
