...
- **[Best Practices](https://antigravity.google/docs/cli/best-practices)**: Master verification
  loops, planning phases, rule files, and session checkpoints.
- **[Troubleshooting](https://antigravity.google/docs/cli/troubleshooting)**: Resolve common path,
