...
terminal title bar dynamically updates to show the active model,
workspace, and agent state.

For details on how to write custom scripts to format the window title,
...
- **[Status Line Command](https://antigravity.google/docs/cli/commands/statusline)**: Customize
