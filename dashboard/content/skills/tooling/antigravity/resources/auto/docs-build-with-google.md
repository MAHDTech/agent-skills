...
curated bundles of primitives, including Skills, MCP servers, and Editor
extensions, that are pre-configured for specific ecosystems.

Instead of searching for individual tools, you can enable these bundles
...
- **What’s included**: Android CLI and Android skills for core
  development tasks including making your UI edge-to-edge and adaptive,
...
- **What’s Included**: A high quality curated bundle of scientific
  skills
- **Key Capabilities**: Improve agent capabilities on scientific
  workflows.
...
- **What’s Included**: Package of agent skills for Chrome DevTools and
  Puppeteer
- **Key Capabilities**: Debugging accessibility (a11y) issues, auditing
  Core Web Vitals (LCP/INP), running visual automation tests, and
...
- **What’s Included**: Package of agent skills for common Dart and
