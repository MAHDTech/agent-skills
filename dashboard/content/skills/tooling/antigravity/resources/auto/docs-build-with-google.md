...
The official Dart and Flutter plugin for building natively compiled, visually stunning applications for mobile, web, desktop, and embedded devices from a single codebase.

* **What’s Included**: Package of agent skills for common Dart and Flutter workflows as well as Dart MCP server interact with your development environment and your running Dart or Flutter application.  
* **Key Capabilities**:   
  * **Enhance Developer experience**: Your agent can leverage deep static analysis tools, package management routines via pub, code formatting, and automated code-renaming capabilities   
  * **Multiplatform development**: Enable your agent to build high-quality apps across mobile, web, desktop with one codebase  
  * **Improve accuracy**: Provide instructions for agents to reliably complete common developer tasks like building adaptive layouts  
* **Learn more**: [Explore Flutter Agentic tools](https://docs.flutter.dev/ai/create-with-ai)
