...
> [!NOTE]
> To toggle the status line on/off or configure it from the TUI, see the **[Status Line Command](https://antigravity.google/docs/cli/commands/statusline)**.
...
- **[Status Line Command](https://antigravity.google/docs/cli/commands/statusline)**: Toggle status line elements interactively.
