...
Guidelines for managing, compiling, and configuring Zola static sites. Always refer to the local [Zola Documentation](@/skills/tooling/zola/resources/auto/documentation.md) for details on configuration schemas, template syntax (Tera), or shortcodes.
