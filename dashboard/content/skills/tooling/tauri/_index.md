...
- Consult the local Tauri documentation: [concept.md](@/skills/tooling/tauri/resources/concept.md) (granular pages fetched from the official v2 reference docs index).
