...
- Start from [concept.md](@/skills/tooling/tauri/resources/concept.md), a short index of core-concept topics that links into the granular reference pages vendored under `resources/` from the official v2 docs.
