+++
title = "distribute-microsoft-store"
[extra]
skill = false
category = "tooling"
mermaid = false
...
guide](/distribute/windows-installer/) for more information on Windows
...
MSI](/distribute/windows-installer/) installers, so you must create a
...
auto-updates](/plugin/updater/) and be [code
signed](/distribute/sign/windows/).
...
the [Offline
Installer](/distribute/windows-installer/#offline-installer) Webview2
installation option.
...
Your application [publisher](/reference/config/#publisher) name cannot
...
[publisher](/reference/config/#publisher) value separately to fix this
conflict:
