+++
title = "reference-javascript-fs-cec1817b"
[extra]
skill = false
category = "tooling"
mermaid = false
...
On iOS, the `fs` plugin automatically manages access to security-scoped
resources when a file URL is accessed. This is required for files
outside the app’s sandbox (e.g., from file picker).

## Example

```
import { open } from '@tauri-apps/plugin-fs';
const file = await open('file:///path/to/file.txt');await file.close();
```
...
directories](https://v2.tauri.app/reference/javascript/fs/#basedirectory) or created with
the [path
API](https://v2.tauri.app/reference/javascript/api/namespacepath/).

The API has a scope configuration that forces you to restrict the paths
that can be accessed using glob patterns.

The scope configuration is an array of glob patterns describing
file/directory paths that are allowed. For instance, this scope
configuration allows **all** enabled `fs` APIs to (only) access files in
the *databases* directory of the [`$APPDATA`
directory](https://v2.tauri.app/reference/javascript/api/namespacepath/#appdatadir):

```
{  "permissions": [    {      "identifier": "fs:scope",      "allow": [{ "path": "$APPDATA/databases/*" }]    }  ]}
```

Scopes can also be applied to specific `fs` APIs by using the API’s
identifier instead of `fs:scope`:

```
{  "permissions": [    {      "identifier": "fs:allow-exists",      "allow": [{ "path": "$APPDATA/databases/*" }]    }  ]}
```

Notice the use of the `$APPDATA` variable. The value is injected at
runtime, resolving to the [app data
directory](https://v2.tauri.app/reference/javascript/api/namespacepath/#appdatadir).
...
in a promise rejection due to denied access.
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L93>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L94>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L92>
...
[`FileHandle`](https://v2.tauri.app/reference/javascript/fs/#filehandle)
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L327>
...
interpreted according to `whence`: `Start` means relative to the start
of the file, `Current` means relative to the current offset, and `End`
means relative to the end. Seek resolves to the new offset relative to
the start of the file.

Seeking to an offset before the start of the file is an error. Seeking
to any positive offset is legal, but the behavior of subsequent I/O
operations on the underlying object is implementation-dependent. It
...
|-----------|--------------------------------------------------|
| `offset`  | `number`                                         |
| `whence`  | [`SeekMode`](https://v2.tauri.app/reference/javascript/fs/#seekmode) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L382>
...
Returns a [`FileInfo`](https://v2.tauri.app/reference/javascript/fs/#fileinfo) for this
file.

###### Returns

[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<[`FileInfo`](https://v2.tauri.app/reference/javascript/fs/#fileinfo)\>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L404>
...
Truncates or extends this file, to reach the specified `len`. If `len`
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L436>
...
Writes `data.byteLength` bytes from `data` to the underlying data
stream. It resolves to the number of bytes written from `data` (`0` \<=
`n` \<= `data.byteLength`) or reject with the error encountered that
caused the write to stop early. `write()` must reject with a non-null
error if would resolve to `n` \< `data.byteLength`. `write()` must not
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L463>
...
|----|----|----|----|
|  `fromPathBaseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `fromPath`. | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L599> |
|  `toPathBaseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `toPath`. | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L601> |
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L476> |
...
- [`WatchOptions`](https://v2.tauri.app/reference/javascript/fs/#watchoptions)

#### Properties

| Property | Type | Description | Inherited from | Defined in |
|----|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | [`WatchOptions`](https://v2.tauri.app/reference/javascript/fs/#watchoptions).[`baseDir`](https://v2.tauri.app/reference/javascript/fs/#basedir-10) | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1195> |
...
|  `recursive?` | `boolean` | Watch a directory recursively | [`WatchOptions`](https://v2.tauri.app/reference/javascript/fs/#watchoptions).[`recursive`](https://v2.tauri.app/reference/javascript/fs/#recursive-3) | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1193> |
...
[`readDir`](https://v2.tauri.app/reference/javascript/fs/#readdir).
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path`. | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1160> |

------------------------------------------------------------------------

### FileInfo

A FileInfo describes a file and is returned by `stat`, `lstat` or
`fstat`.
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L644> |
...
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L559> |
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L676> |
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L738> |
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L882> |
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `newPathBaseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `newPath`. | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L918> |
|  `oldPathBaseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `oldPath`. | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L916> |
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path`. | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L960> |
...
| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path`. | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1019> |
...
|  `type` | [`WatchEventKind`](https://v2.tauri.app/reference/javascript/fs/#watcheventkind) | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1210> |
...
- [`DebouncedWatchOptions`](https://v2.tauri.app/reference/javascript/fs/#debouncedwatchoptions)

#### Properties

| Property | Type | Description | Defined in |
|----|----|----|----|
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1195> |
...
|  `baseDir?` | [`BaseDirectory`](https://v2.tauri.app/reference/javascript/fs/#basedirectory) | Base directory for `path` | **Source**: <https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1071> |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1277>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1218>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1229>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1238>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1247>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1267>
...
Copies the contents and permissions of one file to another specified
...
| `options`? | [`CopyFileOptions`](https://v2.tauri.app/reference/javascript/fs/#copyfileoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L614>
...
Creates a file if none exists or truncates an existing file and resolves
to an instance of [`FileHandle`](https://v2.tauri.app/reference/javascript/fs/#filehandle).
...
| `options`? | [`CreateOptions`](https://v2.tauri.app/reference/javascript/fs/#createoptions) |

#### Returns

[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<[`FileHandle`](https://v2.tauri.app/reference/javascript/fs/#filehandle)\>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L493>
...
|----|----|
| `path` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) |
| `options`? | [`ExistsOptions`](https://v2.tauri.app/reference/javascript/fs/#existsoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1174>
...
Resolves to a [`FileInfo`](https://v2.tauri.app/reference/javascript/fs/#fileinfo) for the
specified `path`. If `path` is a symlink, information for the symlink
will be returned instead of what it points to.
...
|----|----|
| `path` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) |
| `options`? | [`StatOptions`](https://v2.tauri.app/reference/javascript/fs/#statoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1002>
...
|----|----|
| `path` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) |
| `options`? | [`MkdirOptions`](https://v2.tauri.app/reference/javascript/fs/#mkdiroptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L657>
...
[`FileHandle`](https://v2.tauri.app/reference/javascript/fs/#filehandle). The file does not
need to previously exist if using the `create` or `createNew` open
options. It is the callers responsibility to close the file when
finished with it.
...
|----|----|
| `path` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) |
| `options`? | [`OpenOptions`](https://v2.tauri.app/reference/javascript/fs/#openoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L578>
...
|----|----|
| `path` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) |
| `options`? | [`ReadDirOptions`](https://v2.tauri.app/reference/javascript/fs/#readdiroptions) |

#### Returns

[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<[`DirEntry`](https://v2.tauri.app/reference/javascript/fs/#direntry)\[\]\>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L719>
...
Reads and resolves to the entire contents of a file as an array of
bytes. TextDecoder can be used to transform the bytes to string if
required.
...
|----|----|
| `path` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) |
| `options`? | [`ReadFileOptions`](https://v2.tauri.app/reference/javascript/fs/#readfileoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L754>
...
Reads and returns the entire contents of a file as a string using the
specified encoding (default: UTF-8).
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L780>
...
Returns an async AsyncIterableIterator over the lines of a file, decoded
...
You could also call AsyncIterableIterator.next to advance the iterator
so you can lazily read the next line whenever you want.
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L813>
...
|----|----|
| `path` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) |
| `options`? | [`RemoveOptions`](https://v2.tauri.app/reference/javascript/fs/#removeoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L897>
...
| `options`? | [`RenameOptions`](https://v2.tauri.app/reference/javascript/fs/#renameoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L936>
...
Get the size of a file or directory. For files, the `stat` functions can
be used as well.

If `path` is a directory, this function will recursively iterate over
every file and every directory inside of `path` and therefore will be
very time consuming if used on larger directories.
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1359>
...
Starts accessing a security-scoped resource for the given file URL. This
should be called when you’re accessing a file that was opened using a
security-scoped URL (e.g., from a file picker).

Note that accessing security-scoped resources is automatically managed
by the plugin on iOS, so you don’t need to call this function unless you
want to manage the scope manually.

You must call
[`stopAccessingSecurityScopedResource`](https://v2.tauri.app/reference/javascript/fs/#stopaccessingsecurityscopedresource)
when you’re done accessing the resource.
...
const filePath = 'file:///path/to/file.txt';await startAccessingSecurityScopedResource(filePath);// ... use the resource ...
```
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1395>
...
Resolves to a [`FileInfo`](https://v2.tauri.app/reference/javascript/fs/#fileinfo) for the
specified `path`. Will always follow symlinks but will reject if the
symlink points to a path outside of the scope.
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L976>
...
Stops accessing a security-scoped resource for the given file URL. This
should be called when you’re done accessing a file that was opened using
a security-scoped URL (e.g., from a file picker) when using manual
tracking via
[`startAccessingSecurityScopedResource`](https://v2.tauri.app/reference/javascript/fs/#startaccessingsecurityscopedresource).
...
const filePath = 'file:///path/to/file.txt';await startAccessingSecurityScopedResource(filePath);// ... use the resource ...// when you're done with the resource:await stopAccessingSecurityScopedResource(filePath);
```
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1430>
...
If `len` is `0` or not specified, then the entire file contents are
truncated.
...
| `path` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) |
| `len`? | `number` |
| `options`? | [`TruncateOptions`](https://v2.tauri.app/reference/javascript/fs/#truncateoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1042>
...
| `cb` | (`event`) =\> `void` |
| `options`? | [`DebouncedWatchOptions`](https://v2.tauri.app/reference/javascript/fs/#debouncedwatchoptions) |

#### Returns

[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<[`UnwatchFn`](https://v2.tauri.app/reference/javascript/fs/#unwatchfn)\>
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1316>
...
| `paths` | `string` \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL) \| `string`\[\] \| [`URL`](https://developer.mozilla.org/docs/Web/API/URL)\[\] |
| `cb` | (`event`) =\> `void` |
| `options`? | [`WatchOptions`](https://v2.tauri.app/reference/javascript/fs/#watchoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1333>
...
| `options`? | [`WriteFileOptions`](https://v2.tauri.app/reference/javascript/fs/#writefileoptions) |
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1087>
...
Writes UTF-8 string `data` to the given `path`, by default creating a
new file if needed, else overwriting.
...
**Source**:
<https://github.com/tauri-apps/plugins-workspace/blob/v2/plugins/fs/guest-js/index.ts#L1136>
