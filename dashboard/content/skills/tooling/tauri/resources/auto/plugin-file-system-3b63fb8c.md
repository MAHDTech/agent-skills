+++
title = "plugin-file-system-3b63fb8c"
[extra]
skill = false
category = "tooling"
mermaid = false
...
API
Reference:[](https://v2.tauri.app/reference/javascript/fs/)[](https://docs.rs/tauri-plugin-fs)
...
directories](https://v2.tauri.app/reference/javascript/api/namespacepath/#basedirectory) or
created with the [path API](https://v2.tauri.app/reference/javascript/api/namespacepath/).

See [@tauri-apps/plugin-fs -
Security](https://v2.tauri.app/reference/javascript/fs/#security) for more information.

## Paths

The file system plugin offers two ways of manipulating paths: the [base
directory](https://v2.tauri.app/reference/javascript/api/namespacepath/#basedirectory) and
the [path API](https://v2.tauri.app/reference/javascript/api/namespacepath/).

- base directory

  Every API has an options argument that lets you define a
  [baseDir](https://v2.tauri.app/reference/javascript/api/namespacepath/#basedirectory) that
