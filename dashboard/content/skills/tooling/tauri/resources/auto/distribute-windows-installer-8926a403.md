+++
title = "distribute-windows-installer-8926a403"
[extra]
skill = false
category = "tooling"
mermaid = false
...
- [Linux](#tab-panel-4641)
- [macOS](#tab-panel-4642)
...
- [Linux](#tab-panel-4643)
- [macOS](#tab-panel-4644)
...
[webviewInstallMode](https://v2.tauri.app/reference/config/#webviewinstallmode) to
...
setting [webviewInstallMode](https://v2.tauri.app/reference/config/#webviewinstallmode) to
...
See the [WiX configuration](https://v2.tauri.app/reference/config/#wixconfig) for the
...
from pre-defined [configurations](https://v2.tauri.app/reference/config/#wixconfig), you can
...
[`tauri.bundle.windows.wix.template`](https://v2.tauri.app/reference/config/#template-2).
...
[`tauri.bundle.windows.wix.language`](https://v2.tauri.app/reference/config/#language)
...
See the [NSIS configuration](https://v2.tauri.app/reference/config/#nsisconfig) for the
complete list of customization options.
...
`tauri.conf.json` definition. If you need a completely different
installer, a custom template file can be configured on
[`tauri.bundle.windows.nsis.template`](https://v2.tauri.app/reference/config/#template-1).
...
[installMode](https://v2.tauri.app/reference/config/#installmode) to `perMachine`:
...
[installMode](https://v2.tauri.app/reference/config/#installmode) to `both`. Note that the
installer will require Administrator privileges to execute.

See [NSISInstallerMode](https://v2.tauri.app/reference/config/#nsisinstallermode) for more
information.
...
[`tauri.bundle.windows.nsis.languages`](https://v2.tauri.app/reference/config/#languages)
...
files](https://v2.tauri.app/reference/config/#customlanguagefiles).
