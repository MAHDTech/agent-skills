+++
title = "develop-resources-4a4200a7"
[extra]
skill = false
category = "tooling"
mermaid = false
...
- [Syntax](#tab-panel-4596)
- [Explanation](#tab-panel-4597)
...
- [Syntax](#tab-panel-4598)
- [Explanation](#tab-panel-4599)
...
plugin](https://v2.tauri.app/plugin/file-system/), with that, you can read the files through
...
plugin](https://v2.tauri.app/plugin/file-system/)
...
the [`fs` plugin](https://v2.tauri.app/plugin/file-system/).

When using the [`fs` plugin](https://v2.tauri.app/plugin/file-system/), in addition to the
[basic setup](https://v2.tauri.app/plugin/file-system/#setup), you’ll also need to configure
...
[permission system](https://v2.tauri.app/security/capabilities/), use `$RESOURCE/**/*` to
...
To use it with the [`fs` plugin](https://v2.tauri.app/plugin/file-system/):
...
To use it with the [`opener` plugin](https://v2.tauri.app/plugin/opener/):
