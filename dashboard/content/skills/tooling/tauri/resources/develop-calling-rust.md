...
See the [channels documentation](/develop/calling-frontend/#channels)
...
[event.emit](/reference/javascript/api/namespaceevent/#emit) or the
...
can use the
[event.emitTo](/reference/javascript/api/namespaceevent/#emitto) or the
...
[Channels](/develop/calling-frontend/#channels) instead of the event
system.
...
documentation](/develop/calling-frontend/#event-system).
