...
Bundle](/distribute/macos-application-bundle/) for more information on
...
[macOS](/distribute/sign/macos/) and [iOS](/distribute/sign/ios/).
...
[`tauri.conf.json > bundle > category`](/reference/config/#category) to
...
[`tauri.conf.json > identifier`](/reference/config/#identifier) value
