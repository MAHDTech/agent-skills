...
The [`@tauri-apps/api/mocks`](/reference/javascript/api/namespacemocks/)
...
[here](/reference/javascript/api/namespacemocks/#mockipc).
...
[`mockIPC()`](/reference/javascript/api/namespacemocks/#mockipc) with
...
System](/develop/calling-frontend/#event-system) to simulate events
