+++
title = "develop-plugins-develop-mobile"
[extra]
skill = false
category = "tooling"
mermaid = false
...
guide](/develop/plugins/#initialize-plugin-project) to initialize a new
plugin project.
...
section](/develop/plugins/#plugin-configuration) of the Plugin
...
plugins](/develop/plugins/#lifecycle-events) in the Plugin Development
guide.
...
the
[`addPluginListener`](/reference/javascript/api/namespacecore/#addpluginlistener)
helper function:
