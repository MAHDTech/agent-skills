...
guide](/start/prerequisites/) to install all of the dependencies
required by Tauri. For a more detailed walk through, see [Create a
Project](/start/create-project/#using-create-tauri-app)
...
Structure](/start/project-structure/) to understand what each file does.
...
guide](/start/frontend/) contains common configurations for popular
frontend frameworks.
...
available for [Tauri Plugins](/develop/plugins/).
...
the community in the [Plugins section](/plugin/).
