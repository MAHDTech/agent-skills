+++
title = "docs-components-searchbox-index"
[extra]
skill = false
category = "tooling"
mermaid = false
...
The `shortcut` attribute accepts the same syntax as [`<pagefind-modal-trigger>`](https://pagefind.app/docs/components/modal-trigger/#customizing-the-shortcut).
