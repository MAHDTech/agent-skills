+++
title = "docs-components-config-index"
[extra]
skill = false
category = "tooling"
mermaid = false
...
| `highlight-param` | string | — | Add the search term as a query parameter under this key for use with the [highlight script](https://pagefind.app/docs/highlighting/) |
