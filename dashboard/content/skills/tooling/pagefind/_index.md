...
Guidelines for indexing static websites and configuring search capabilities using Pagefind. Always consult the local [Pagefind Docs](@/skills/tooling/pagefind/resources/docs-index.md) and [Pagefind Config Options](@/skills/tooling/pagefind/resources/docs-config-options-index.md) for full options reference.
