...
```json
{
  ...
  "params": {
    ...
    "prompt": [
      {
        "type": "text",
        "text": "Which plugins are loaded? Which MCP servers are loaded? List them all."
      }
    ]
  }
}
...
```json
{
  ...
  "params": {
    ...
    "prompt": [
      {
        "type": "text",
        "text": "Write all the plugins and MCP servers info you just told me into a file called THIRD.md in the current directory."
      }
    ]
  }
}
