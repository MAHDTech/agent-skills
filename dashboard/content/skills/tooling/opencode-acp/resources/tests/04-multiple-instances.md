...
```json
{
  ...
  "params": {
    ...
    "clientInfo": {"name": "clawdbot", "title": "Clawdbot", "version": "1.0.0"}
  }
}
```
...
```json
{
  ...
  "id": 1,
  "method": "session/new",
  "params": {"cwd": "/path/to/playground", "mcpServers": []}
}
```
...
```json
{
  ...
  "params": {
    ...
    "prompt": [
      {
        "type": "text",
        "text": "Create a file called 02-FIRST.md with a short greeting."
      }
    ]
  }
}
...
```json
{
  ...
  "params": {
    ...
    "prompt": [
      {
        "type": "text",
        "text": "Create a file called 03-FIRST.md with a short greeting."
      }
    ]
  }
}
