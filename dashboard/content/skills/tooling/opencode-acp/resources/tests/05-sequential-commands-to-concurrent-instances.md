+++
title = "05-sequential-commands-to-concurrent-instances"
[extra]
skill = false
category = "tooling"
mermaid = false
...
```json
{
  ...
  "params": {
    ...
    "prompt": [
      {
        "type": "text",
        "text": "Create a file called 02-SECOND.md with the text: Second file from instance 2"
      }
    ]
  }
}
...
```json
{
  ...
  "params": {
    ...
    "prompt": [
      {
        "type": "text",
        "text": "Create a file called 03-SECOND.md with the text: Second file from instance 3"
      }
    ]
  }
}
