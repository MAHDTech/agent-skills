+++
title = "announcements-session-list-stabilized"
[extra]
skill = false
category = "tooling"
mermaid = false
...
For the shipped protocol, see [Session List](/protocol/v1/session-list). For the design history, see the [Session List RFD](/rfds/session-list).
