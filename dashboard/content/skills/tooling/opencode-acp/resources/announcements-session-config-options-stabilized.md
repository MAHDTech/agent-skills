+++
title = "announcements-session-config-options-stabilized"
[extra]
skill = false
category = "tooling"
mermaid = false
...
The stable protocol documentation is available in [Session Config Options](/protocol/v1/session-config-options), and the design history remains in the [Session Config Options RFD](/rfds/session-config-options).
