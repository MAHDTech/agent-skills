...
No. It removes Client execution and control. The [Terminal Output](@/skills/tooling/opencode-acp/resources/rfds-v2-terminal-output.md) RFD adds a separate Agent-owned, display-only stream for command output.
