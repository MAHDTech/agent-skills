...
* [New Prompt Lifecycle](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-prompt.md)
* [Enum Variant Extension](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-enum-variant-extension.md)
* [Required Session Methods](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-required-session-methods.md)
* [Session Resume Replay](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-session-resume-replay.md)
* [Client Filesystem and Terminal Execution Surface](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-client-filesystem-terminal-capabilities.md)
* [Terminal Output](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-terminal-output.md)
* [Plan Variants](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-plan-variants.md)
* [Tool Call Updates](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-tool-call-updates.md)
* [Diff File States](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-diff-file-states.md)
* [Permission Requests](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-permission-requests.md)
* [Message Updates and Chunks](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-message-updates.md)
* [Remote Transports](@/skills/tooling/opencode-acp/resources/auto/rfds-streamable-http-websocket-transport.md)
...
* Clean up capability naming and organization:
  ...
  * Remove `session/load` from v2. `session/resume` handles both no-replay resume and full replay by using the optional `replayFrom` cursor from the [Session Resume Replay](@/skills/tooling/opencode-acp/resources/auto/rfds-v2-session-resume-replay.md) RFD.
