+++
title = "protocol-v2-session-config-options"
[extra]
skill = false
category = "tooling"
mermaid = false
...
During [Session Setup](https://agentclientprotocol.com/protocol/v2/session-setup) the Agent **MAY** return a list of configuration options and their current values:
