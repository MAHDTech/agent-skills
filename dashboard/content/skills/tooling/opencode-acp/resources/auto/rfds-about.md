...
The project currently has a design team with the [Zed team as the lead (BDFL)](@/skills/tooling/opencode-acp/resources/auto/community-governance.md). Champions from the core team guide RFDs through the process, but final decisions rest with the team lead. This structure maintains velocity while anticipating future governance expansion.
