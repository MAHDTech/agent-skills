...
The [InitializeRequest](https://agentclientprotocol.com/protocol/v1/schema#initializerequest) message now includes an optional clientInfo field, and the [InitializeResponse](https://agentclientprotocol.com/protocol/v1/schema#initializeresponse) message includes an optional agentInfo field.
