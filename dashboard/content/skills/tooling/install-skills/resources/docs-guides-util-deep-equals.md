+++
title = "docs-guides-util-deep-equals"
[extra]
skill = false
category = "tooling"
mermaid = false
...
`Bun.deepEquals()` checks if two objects are deeply equal. `expect().toEqual()` in Bun's [test runner](https://bun.com/test/writing-tests) uses it internally.
