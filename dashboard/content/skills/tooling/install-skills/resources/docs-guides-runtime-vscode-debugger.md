+++
title = "docs-guides-runtime-vscode-debugger"
[extra]
skill = false
category = "tooling"
mermaid = false
...
<Note>The VS Code extension is buggy. We recommend the [web debugger](https://bun.com/guides/runtime/web-debugger) instead.</Note>
