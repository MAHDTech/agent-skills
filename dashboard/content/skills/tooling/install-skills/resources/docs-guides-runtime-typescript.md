+++
title = "docs-guides-runtime-typescript"
[extra]
skill = false
category = "tooling"
mermaid = false
...
If you're using TypeScript 6.0 or later, you also need `"types": ["bun"]` in your `compilerOptions`. See [TypeScript 6 and 7](https://bun.com/typescript-6) for details.

***

See [TypeScript](https://bun.com/runtime/typescript).
