...
See [`bun install`](https://bun.com/pm/cli/install) and [`bun outdated`](https://bun.com/pm/cli/outdated).
...
Filters respect your [workspace configuration](https://bun.com/pm/workspaces): if your `package.json` specifies which packages are part of the workspace,
