...
Registers a callback to be run after the bundle is complete. The callback receives the [`BuildOutput`](https://bun.com/docs/bundler#outputs) object containing the build results, including output files and any build messages.
