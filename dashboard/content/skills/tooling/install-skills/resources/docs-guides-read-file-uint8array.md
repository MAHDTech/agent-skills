+++
title = "docs-guides-read-file-uint8array"
[extra]
skill = false
category = "tooling"
mermaid = false
...
See [Typed arrays](https://bun.com/runtime/binary-data#typedarray) for more on working with `Uint8Array` and other binary data formats in Bun.
