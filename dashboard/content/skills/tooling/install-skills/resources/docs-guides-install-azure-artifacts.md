+++
title = "docs-guides-install-azure-artifacts"
[extra]
skill = false
category = "tooling"
mermaid = false
...
Then assign your Azure Personal Access Token to the `NPM_PASSWORD` environment variable. Bun [automatically reads](https://bun.com/runtime/environment-variables) `.env` files, so create a file called `.env` in your project root. Don't base64 encode the token; Bun does that for you.
