+++
title = "docs-guides-websocket-context"
[extra]
skill = false
category = "tooling"
mermaid = false
...
With [Bun.serve()](https://bun.com/runtime/http/websockets#contextual-data), set this "contextual data" by passing a `data` parameter to `server.upgrade()` when upgrading the connection.
