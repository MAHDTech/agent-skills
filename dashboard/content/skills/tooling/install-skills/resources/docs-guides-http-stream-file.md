+++
title = "docs-guides-http-stream-file"
[extra]
skill = false
category = "tooling"
mermaid = false
...
[`Bun.file()`](https://bun.com/runtime/file-io#reading-files-bun-file) reads a file from disk and returns a `BunFile` instance, which you can pass directly to the `new Response` constructor.
...
Putting it all together with [`Bun.serve()`](https://bun.com/runtime/http/server).
