+++
title = "docs-guides-html-rewriter-extract-links"
[extra]
skill = false
category = "tooling"
mermaid = false
...
Bun's [HTMLRewriter](https://bun.com/runtime/html-rewriter) API extracts links from HTML. Chain CSS selectors to match the elements, text, and attributes you want to process, then pass `.transform` a `Response`, `ArrayBuffer`, or `string`.
...
See [`HTMLRewriter`](https://bun.com/runtime/html-rewriter).
