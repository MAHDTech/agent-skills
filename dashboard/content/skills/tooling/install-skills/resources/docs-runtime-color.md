...
Like many of Bun's APIs, you can invoke `Bun.color` at bundle time with a [macro](https://bun.com/bundler/macros) for use in client-side JavaScript builds:
