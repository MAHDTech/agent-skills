...
Bun reads these environment variables from [`.env` files](https://bun.com/runtime/environment-variables) or from the process environment at initialization time (`process.env` is not used for this).
