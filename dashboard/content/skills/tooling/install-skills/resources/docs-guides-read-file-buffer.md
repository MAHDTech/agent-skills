+++
title = "docs-guides-read-file-buffer"
[extra]
skill = false
category = "tooling"
mermaid = false
...
See [Buffer](https://bun.com/runtime/binary-data#buffer) for more on working with `Buffer` and other binary data formats in Bun.
