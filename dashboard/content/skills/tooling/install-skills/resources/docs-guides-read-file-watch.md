+++
title = "docs-guides-read-file-watch"
[extra]
skill = false
category = "tooling"
mermaid = false
...
Refer to [API > Binary data > Typed arrays](https://bun.com/runtime/binary-data#typedarray) for more information on working with `Uint8Array` and other binary data formats in Bun.
