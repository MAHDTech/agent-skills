+++
title = "docs-guides-test-testing-library"
[extra]
skill = false
category = "tooling"
mermaid = false
...
First, install [Happy DOM](https://github.com/capricorn86/happy-dom) (see [Bun's Happy DOM guide](https://bun.com/guides/test/happy-dom)).
...
See the [Testing Library docs](https://testing-library.com/), the [Happy DOM repo](https://github.com/capricorn86/happy-dom), and [DOM testing](https://bun.com/test/dom).
