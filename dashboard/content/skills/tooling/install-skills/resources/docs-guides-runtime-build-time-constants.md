+++
title = "docs-guides-runtime-build-time-constants"
[extra]
skill = false
category = "tooling"
mermaid = false
...
* [Define constants at runtime](https://bun.com/guides/runtime/define-constant) - Using `--define` with `bun run`
* [Building executables](https://bun.com/bundler/executables) - Complete guide to `bun build --compile`
* [Bundler API](https://bun.com/bundler) - Full bundler documentation including `define` option
