...
Supported glob patterns (subset of [Bun.Glob](https://bun.com/docs/api/glob) syntax):
...
See [Bun.Glob](https://bun.com/docs/api/glob) for the full glob syntax including escaping and advanced patterns.
