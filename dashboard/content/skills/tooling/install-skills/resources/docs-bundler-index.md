...
Like the Bun runtime, the bundler supports a range of file types by default. The following table lists the bundler's standard "loaders". See [loaders](https://bun.com/bundler/loaders).
...
<Info>See [loaders](https://bun.com/bundler/loaders) for more on the file loader.</Info>

### Plugins

Plugins can override or extend the behavior described in this table. See [loaders](https://bun.com/bundler/loaders).
...
Bun's plugin system is shared by the runtime and the bundler. See [plugins](https://bun.com/bundler/plugins).
...
| `loader`    | The loader used to interpret the file. See [loaders](https://bun.com/bundler/loaders) for how Bun maps file extensions to built-in loaders.                               |
...
See [standalone executables](https://bun.com/bundler/executables).
