+++
title = "docs-guides-install-workspaces"
[extra]
skill = false
category = "tooling"
mermaid = false
...
To add npm dependencies to a particular workspace, `cd` to that directory and run `bun add` as you normally would. Bun detects that you are in a workspace and [hoists](https://bun.com/pm/isolated-installs) the dependency as needed.
