+++
title = "docs-pm-security-scanner-api"
[extra]
skill = false
category = "tooling"
mermaid = false
...
* [Configuration (bunfig.toml)](https://bun.com/runtime/bunfig#install-security-scanner)
* [Package Manager](https://bun.com/installation)
