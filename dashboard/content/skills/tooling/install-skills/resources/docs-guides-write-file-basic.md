+++
title = "docs-guides-write-file-basic"
[extra]
skill = false
category = "tooling"
mermaid = false
...
Use [`Bun.write()`](https://bun.com/runtime/file-io#writing-files-bun-write) to write a string to disk at an *absolute path*. The first argument is a *destination*; the second is the *data* to write.
