+++
title = "docs-guides-html-rewriter-extract-social-meta"
[extra]
skill = false
category = "tooling"
mermaid = false
...
Bun's [HTMLRewriter](https://bun.com/runtime/html-rewriter) API extracts social share images and Open Graph metadata from HTML by matching CSS selectors against the elements, text, and attributes you want to process. Use it to build link previews, social media cards, or web scrapers.
