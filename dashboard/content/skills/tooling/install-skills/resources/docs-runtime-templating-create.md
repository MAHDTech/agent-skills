+++
title = "docs-runtime-templating-create"
[extra]
skill = false
category = "tooling"
mermaid = false
...
To create an empty project, use [`bun init`](https://bun.com/runtime/templating/init).
...
1. Uses [Bun's JavaScript bundler](https://bun.com/bundler) to analyze your module graph.
...
5. Installs any missing dependencies using [`bun install --only-missing`](https://bun.com/pm/cli/install).
