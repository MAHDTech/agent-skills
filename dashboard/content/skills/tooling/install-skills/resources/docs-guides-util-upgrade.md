+++
title = "docs-guides-util-upgrade"
[extra]
skill = false
category = "tooling"
mermaid = false
...
* [Installation](https://bun.com/installation) — Install Bun for the first time
* [Update packages](https://bun.com/pm/cli/update) — Update dependencies to latest versions
