+++
title = "docs-guides-test-mock-clock"
[extra]
skill = false
category = "tooling"
mermaid = false
...
Call `setSystemTime` in a [lifecycle hook](https://bun.com/test/lifecycle) like `beforeAll` to give your tests a deterministic "fake clock".
...
See [Dates and times](https://bun.com/test/dates-times).
