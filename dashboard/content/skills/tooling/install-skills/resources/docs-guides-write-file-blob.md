+++
title = "docs-guides-write-file-blob"
[extra]
skill = false
category = "tooling"
mermaid = false
...
Use [`Bun.write()`](https://bun.com/runtime/file-io#writing-files-bun-write) to write a `Blob` to disk. The first argument is a *destination*, like an absolute path or `BunFile` instance. The second argument is the *data* to write.
