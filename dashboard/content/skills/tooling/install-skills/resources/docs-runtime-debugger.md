...
Visual Studio Code support for debugging Bun scripts is experimental. To use it, install the [Bun VSCode extension](https://bun.com/guides/runtime/vscode-debugger).
