+++
title = "docs-project-benchmarking"
[extra]
skill = false
category = "tooling"
mermaid = false
...
> The [web debugger](https://bun.com/runtime/debugger#inspect) timeline also tracks the memory usage of the running debug session.
