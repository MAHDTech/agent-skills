...
For the complete CLI reference, tool and permission details, and agent configuration, see the official OpenCode documentation at [docs.md](@/skills/tooling/opencode/resources/docs.md).
