...
- [/tars-run-factory](@/skills/tooling/tars-run-factory/_index.md) - reach for this to run the unattended TARS software factory foreman over a repository backlog via the agy CLI and tars-agy plugin.
