...
- [/backlog-prepare](@/skills/planning/backlog-prepare/_index.md) — reach for this to reset the environment and prepare the workspace before starting a full backlog loop, cleaning up git worktrees and branches.
...
- [/backlog-review](@/skills/review/backlog-review/_index.md) — reach for this during the implementation phase of the backlog loop to assess a subagent's code changes for compliance with the spec and repo standards.
