...
4. **Generate Tickets**: For each verified finding, write a new ticket file to `.tars/issues/todo/` following the guidelines and structure defined in the [backlog-create-issue](@/skills/planning/backlog-create-issue/_index.md) skill.
