...
Create `00-status.md` before Gate 1 and update it at every approval - its shape is in [`resources/manual/status-file.md`](@/skills/planning/software-factory/resources/manual/status-file.md).
...
Interview the user with `/grilling` until the answers are sharp, fill the template in [`resources/manual/gate-1-product.md`](@/skills/planning/software-factory/resources/manual/gate-1-product.md), and save it as `01-product.md`.
...
Fill the template in [`resources/manual/gate-2-architecture.md`](@/skills/planning/software-factory/resources/manual/gate-2-architecture.md) and save it as `02-architecture.md`.
...
Fill the template in [`resources/manual/gate-3-program-design.md`](@/skills/planning/software-factory/resources/manual/gate-3-program-design.md) and save it as `03-program-design.md`. Types and signatures carry no bodies - a human reads them in seconds and says "right" or "wrong".
