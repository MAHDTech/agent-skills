...
1. **[overview-and-architecture.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/overview-and-architecture.md)**
...
2. **[requirements-and-sizing.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/requirements-and-sizing.md)**
...
3. **[deployment-and-installation.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/deployment-and-installation.md)**
...
4. **[tls-and-certificates.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/tls-and-certificates.md)**
...
5. **[authentication-and-authorization.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/authentication-and-authorization.md)**
...
6. **[licensing-and-settings.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/licensing-and-settings.md)**
...
7. **[generative-ai-models.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/generative-ai-models.md)**
...
8. **[local-endpoints.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/local-endpoints.md)**
...
9. **[batch-inference.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/batch-inference.md)**
...
10. **[unified-endpoints.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/unified-endpoints.md)**
...
11. **[model-and-endpoint-security.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/model-and-endpoint-security.md)**
...
12. **[api-keys-and-audit.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/api-keys-and-audit.md)**
...
13. **[mcp-servers.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/mcp-servers.md)**
...
14. **[observability-and-opentelemetry.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/observability-and-opentelemetry.md)**
...
15. **[nai-labs-and-support.md](@/skills/engineering/nutanix-enterprise-ai/resources/manual/nai-labs-and-support.md)**
