...
5. **Run the implementation review**: on a green gate, call the `tars-backlog-review` skill (see [tars-backlog-review](@/skills/review/tars-backlog-review/_index.md)) against the spoke's clone and ticket file.
