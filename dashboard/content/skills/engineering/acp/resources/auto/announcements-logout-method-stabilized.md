+++
title = "announcements-logout-method-stabilized"
[extra]
skill = false
...
The [Logout Method RFD](https://agentclientprotocol.com/rfds/logout-method) has moved to Completed and the `logout` method is stabilized.
