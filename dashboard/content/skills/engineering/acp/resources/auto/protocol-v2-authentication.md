...
[initialization](https://agentclientprotocol.com/protocol/v2/initialization). Agents advertise available
...
See the [schema](https://agentclientprotocol.com/protocol/v2/schema#authmethod) for the full
