...
[initialization](https://agentclientprotocol.com/protocol/v1/initialization). Agents advertise available
...
See the [schema](https://agentclientprotocol.com/protocol/v1/schema#authmethod) for the full
`AuthMethod` definitions and the [Terminal Authentication
RFD](https://agentclientprotocol.com/rfds/auth-methods) for the design.
