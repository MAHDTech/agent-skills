+++
title = "announcements-message-id-stabilized"
[extra]
skill = false
...
The [Message ID RFD](https://agentclientprotocol.com/rfds/message-id) has moved to Completed and optional Agent-generated `messageId` fields are stabilized in ACP v1.
