+++
title = "rfds-request-cancellation"
[extra]
skill = false
...
* **MUST** send one of these responses for the original request:
  ...
  * An error response with code [`-32800` (Request Cancelled)](https://agentclientprotocol.com/protocol/v1/draft/schema#errorcode)
...
| Repository                             | Pull request / commit                                                                                                                       | Status                   |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| `zed-industries/zed`                   | [zed-industries/zed#59593](https://github.com/zed-industries/zed/pull/59593)                                                                | Merged                   |
| `agentclientprotocol/rust-sdk`         | [agentclientprotocol/rust-sdk#179](https://github.com/agentclientprotocol/rust-sdk/pull/179)                                                | Merged                   |
| `agentclientprotocol/typescript-sdk`   | [agentclientprotocol/typescript-sdk#195](https://github.com/agentclientprotocol/typescript-sdk/pull/195)                                    | Merged                   |
| `agentclientprotocol/claude-agent-acp` | [agentclientprotocol/claude-agent-acp#801](https://github.com/agentclientprotocol/claude-agent-acp/pull/801)                                | Merged                   |
| `agentclientprotocol/codex-acp`        | [agentclientprotocol/codex-acp#221](https://github.com/agentclientprotocol/codex-acp/pull/221)                                              | Merged                   |
| `agentclientprotocol/kotlin-sdk`       | [agentclientprotocol/kotlin-sdk@f345883](https://github.com/agentclientprotocol/kotlin-sdk/commit/f3458831da628e26ee29c4a5834d55b443bf5a31) | Needs method name update |
...
* 2026-06-29: Moved to Completed and stabilized request cancellation in the protocol artifacts.
* 2026-06-24: Move to Preview stage
