+++
title = "seps-2149-working-group-charter-template"
[extra]
skill = false
...
* Hold at least Member status on the [MCP Contributor Ladder](@/skills/engineering/mcp/resources/auto/seps-2148-contributor-ladder.md)
...
All groups use the following participation tiers. Note that **WG Member** is a group-specific participation level distinct from the org-wide **Member** role defined in the [Contributor Ladder](@/skills/engineering/mcp/resources/auto/seps-2148-contributor-ladder.md) — an individual may be a WG Member in a specific group without holding org-wide Member status, and vice versa.
