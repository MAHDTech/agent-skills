+++
title = "specification-2025-11-25-basic-utilities-tasks"
[extra]
skill = false
...
\<Note\>
  ...
  While this note is not prescriptive regarding the specific usage of SSE streams, all implementations **MUST** continue to comply with the existing [Streamable HTTP transport specification](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-transports.md#sending-messages-to-the-server).
</Note>
...
Task-augmented requests support progress notifications as defined in the [progress](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-utilities-progress.md) specification. The `progressToken` provided in the initial request remains valid throughout the task lifetime.
