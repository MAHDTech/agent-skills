+++
title = "docs-2025-11-25-develop-build-client"
[extra]
skill = false
...
Before you begin, it helps to have gone through our [Build an MCP Server](https://modelcontextprotocol.io/docs/2025-11-25/develop/build-server) tutorial so you can understand how clients and servers communicate.
...
\<Tabs\>
  <Tab title="Python">
    ...
    * Graceful shutdown procedures
    ...
    4. **Tool Names**
       * Tool names can be validated according to the format specified [here](https://modelcontextprotocol.io/specification/2025-11-25/server/tools#tool-names)
