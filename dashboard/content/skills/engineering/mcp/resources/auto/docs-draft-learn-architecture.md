+++
title = "docs-draft-learn-architecture"
[extra]
skill = false
...
For specific implementation details, please refer to the documentation for your [language-specific SDK](https://modelcontextprotocol.io/docs/draft/sdk).
...
* [MCP SDKs](https://modelcontextprotocol.io/docs/draft/sdk): SDKs for different programming languages that implement MCP.
...
* **Client features**: Enables servers to elicit input from the user. Sampling is [deprecated](https://modelcontextprotocol.io/specification/draft/deprecated) as of protocol version `2026-07-28`.
...
For more details about server primitives see [server concepts](@/skills/engineering/mcp/resources/auto/docs-draft-learn-server-concepts.md).
...
Elicitation requests are delivered through the [Multi Round-Trip Requests](https://modelcontextprotocol.io/specification/draft/basic/patterns/mrtr) pattern, explained in the [elicitation overview](https://modelcontextprotocol.io/docs/draft/learn/client-concepts#elicitation).
...
For more details about client primitives see [client concepts](@/skills/engineering/mcp/resources/auto/docs-draft-learn-client-concepts.md).
...
\<Steps\>
  ...
  <Step title="Tool Discovery (Primitives)">
    ...
    The `tools/list` request requires no parameters beyond the standard `_meta` fields that accompany every MCP request. It also accepts an optional `cursor` parameter for [pagination](https://modelcontextprotocol.io/specification/draft/server/utilities/pagination), which the example above omits.
    ...
    * **`inputSchema`**: A JSON Schema that defines the expected input parameters, enabling type validation and providing clear documentation about required and optional parameters
    ...
    Clients that federate many servers can use [progressive tool discovery](https://modelcontextprotocol.io/docs/draft/develop/clients/client-best-practices#progressive-tool-discovery) rather than loading every tool upfront.
  </Step>
