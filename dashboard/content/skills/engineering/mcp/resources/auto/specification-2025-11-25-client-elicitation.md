+++
title = "specification-2025-11-25-client-elicitation"
[extra]
skill = false
...
[initialization](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-lifecycle.md#initialization):
...
\<Note\>
  **Important**: URL mode elicitation is *not* for authorizing the MCP client's
  ...
  authorization](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-authorization.md)). Instead, it's used when the MCP
...
* For remote MCP servers, user identification **MUST** be derived from credentials acquired via [MCP authorization](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-authorization.md) when possible (e.g. `sub` claim)
...
Authorization with external APIs enabled by URL mode elicitation is separate from [MCP authorization](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-authorization.md). MCP servers **MUST NOT** rely on URL mode elicitation to authorize users for themselves.

#### Understanding the Distinction

* **MCP Authorization**: Required OAuth flow between the MCP client and MCP server (covered in the [authorization specification](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-authorization.md))
...
Instead, servers **SHOULD** follow [security best practices](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices).

Non-normative examples:

* Incorrect: Treat user input like "I am [joe@example.com](mailto:joe@example.com)" as authoritative
* Correct: Rely on [authorization](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-authorization.md) to identify the user
...
Typically identity verification is done by leveraging the [MCP authorization server](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-basic-authorization.md) to identify the user, through a session cookie or equivalent in the browser.
