...
| "Package validation failed" | Verify your package successfully published to the package registry (e.g., npm, PyPI), and that your package has the [necessary verification information](@/skills/engineering/mcp/resources/auto/registry-package-types.md). |
