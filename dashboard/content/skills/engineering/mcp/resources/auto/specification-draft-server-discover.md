+++
title = "specification-draft-server-discover"
[extra]
skill = false
...
identity. This operation supports [caching](https://modelcontextprotocol.io/specification/draft/server/utilities/caching).
