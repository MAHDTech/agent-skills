+++
title = "docs-draft-tools-debugging"
[extra]
skill = false
...
1. **[MCP Inspector](https://modelcontextprotocol.io/docs/draft/tools/inspector)**: interactive, transport-agnostic
...
2. **Server logging**: structured logs to stderr (stdio transport) or via
   ...
   [Logging](https://modelcontextprotocol.io/specification/draft/server/utilities/logging) over the protocol
...
[stdio transport](https://modelcontextprotocol.io/specification/draft/basic/transports/stdio), all messages
...
setting the
[`io.modelcontextprotocol/logLevel`](https://modelcontextprotocol.io/specification/draft/server/utilities/logging#per-request-log-level)
...
[`claude_desktop_config.json`](https://modelcontextprotocol.io/docs/draft/develop/connect-local-servers); the same
...
3. Test standalone with [Inspector](https://modelcontextprotocol.io/docs/draft/tools/inspector)
4. Verify
   [protocol compatibility](https://modelcontextprotocol.io/docs/draft/learn/versioning#negotiation): call
   [`server/discover`](https://modelcontextprotocol.io/specification/draft/server/discover) to see which
...
5. Check the
   [per-request `_meta` fields](https://modelcontextprotocol.io/specification/draft/basic/index#meta):
   ...
   [elicitation](https://modelcontextprotocol.io/specification/draft/client/elicitation), it returns a
   `MissingRequiredClientCapabilityError` (`-32021`) naming the missing
   capabilities. Inspect the request's `_meta` and the
   [`server/discover`](https://modelcontextprotocol.io/specification/draft/server/discover) response to
...
1. Initial Development
   * Use [Inspector](https://modelcontextprotocol.io/docs/draft/tools/inspector) for basic testing
...
* **Quick iteration**: Use [Inspector](https://modelcontextprotocol.io/docs/draft/tools/inspector) during
  development
...
[Security Best Practices](https://modelcontextprotocol.io/docs/draft/tutorials/security/security_best_practices).
...
1. **First Steps**
   * Check server logs
   * Test with [Inspector](https://modelcontextprotocol.io/docs/draft/tools/inspector)
