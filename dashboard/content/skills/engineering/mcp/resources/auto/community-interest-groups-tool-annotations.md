+++
title = "community-interest-groups-tool-annotations"
[extra]
skill = false
...
* **[Skills Over MCP WG](https://modelcontextprotocol.io/community/working-groups/skills-over-mcp)** - Skill-level metadata may interact with tool annotations for discovery and filtering
