+++
title = "docs-2024-11-05-develop-build-with-agent-skills"
[extra]
skill = false
...
**Remote [HTTP with SSE](https://modelcontextprotocol.io/specification/2024-11-05/basic/transports#http-with-sse)**
...
**Local [stdio](https://modelcontextprotocol.io/specification/2024-11-05/basic/transports#stdio)** remains available
