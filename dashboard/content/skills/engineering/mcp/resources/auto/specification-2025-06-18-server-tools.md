+++
title = "specification-2025-06-18-server-tools"
[extra]
skill = false
...
or data using a suitable [URI scheme](@/skills/engineering/mcp/resources/auto/specification-2025-06-18-server-resources.md#common-uri-schemes). Servers that use embedded resources **SHOULD** implement the `resources` capability:
