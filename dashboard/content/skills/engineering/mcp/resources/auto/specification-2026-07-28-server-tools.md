+++
title = "specification-2026-07-28-server-tools"
[extra]
skill = false
...
or data using a suitable [URI scheme](@/skills/engineering/mcp/resources/auto/specification-2026-07-28-server-resources.md#common-uri-schemes). Servers that use embedded resources **SHOULD** implement the `resources` capability:
