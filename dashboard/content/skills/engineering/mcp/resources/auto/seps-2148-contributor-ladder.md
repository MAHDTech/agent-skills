+++
title = "seps-2148-contributor-ladder"
[extra]
skill = false
...
The detailed escalation procedure for Working Group and Interest Group disputes — including the designation of a Core Maintainer without shared organizational affiliation to resolve the issue — is defined in [SEP-2149 §1.5](@/skills/engineering/mcp/resources/auto/seps-2149-working-group-charter-template.md).
