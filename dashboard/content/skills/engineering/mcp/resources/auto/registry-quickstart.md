...
* **GitHub account** — The MCP Registry supports [multiple authentication methods](@/skills/engineering/mcp/resources/auto/registry-authentication.md). For simplicity, this tutorial will use GitHub-based authentication, so you will need a [GitHub](https://github.com/) account.
...
* Learn about [support for other package types](@/skills/engineering/mcp/resources/auto/registry-package-types.md).
* Learn about [support for remote servers](@/skills/engineering/mcp/resources/auto/registry-remote-servers.md).
* Learn how to [use other authentication methods](@/skills/engineering/mcp/resources/auto/registry-authentication.md), such as [DNS authentication](@/skills/engineering/mcp/resources/auto/registry-authentication.md#dns-authentication) which enables custom domains for server name prefixes.
* Learn how to [automate publishing with GitHub Actions](@/skills/engineering/mcp/resources/auto/registry-github-actions.md).
