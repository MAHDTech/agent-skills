+++
title = "docs-2024-11-05-learn-architecture"
[extra]
skill = false
...
For specific implementation details, please refer to the documentation for your [language-specific SDK](https://modelcontextprotocol.io/docs/2024-11-05/sdk).
...
* [MCP SDKs](https://modelcontextprotocol.io/docs/2024-11-05/sdk): SDKs for different programming languages that implement MCP.
...
For more details about server primitives see [server concepts](@/skills/engineering/mcp/resources/auto/docs-2024-11-05-learn-server-concepts.md).
...
For more details about client primitives see [client concepts](@/skills/engineering/mcp/resources/auto/docs-2024-11-05-learn-client-concepts.md).
