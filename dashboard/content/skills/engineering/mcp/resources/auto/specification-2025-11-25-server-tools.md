+++
title = "specification-2025-11-25-server-tools"
[extra]
skill = false
...
or data using a suitable [URI scheme](@/skills/engineering/mcp/resources/auto/specification-2025-11-25-server-resources.md#common-uri-schemes). Servers that use embedded resources **SHOULD** implement the `resources` capability:
