+++
title = "docs-2025-11-25-tutorials-security-security_best_practices"
[extra]
skill = false
...
2. The attacker obtains an existing session ID and sends a malicious
   ...
   * When a server supports
     [redelivery/resumable streams](https://modelcontextprotocol.io/specification/2025-11-25/basic/transports#resumability-and-redelivery),
