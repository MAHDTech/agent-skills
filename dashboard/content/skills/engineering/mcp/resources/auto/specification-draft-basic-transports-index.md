+++
title = "specification-draft-basic-transports-index"
[extra]
skill = false
...
[message patterns](https://modelcontextprotocol.io/specification/draft/basic/patterns) are part of the core
protocol and are the same on every binding. The binding pages specify the
standard transports:

1. [stdio](https://modelcontextprotocol.io/specification/draft/basic/transports/stdio): newline-delimited
...
[message patterns](https://modelcontextprotocol.io/specification/draft/basic/patterns), servers do not
...
[`_meta.io.modelcontextprotocol/*`](https://modelcontextprotocol.io/specification/draft/basic/index#meta)
fields.
...
[HTTP headers](https://modelcontextprotocol.io/specification/draft/basic/transports/streamable-http#request-metadata)
...
[Cancellation](https://modelcontextprotocol.io/specification/draft/basic/patterns/cancellation).
...
[message patterns](https://modelcontextprotocol.io/specification/draft/basic/patterns), and the per-request
...
[stdio framing](https://modelcontextprotocol.io/specification/draft/basic/transports/stdio) rather than
...
[Versioning: Backward Compatibility](https://modelcontextprotocol.io/specification/draft/basic/versioning#backward-compatibility-with-initialization-based-versions),
