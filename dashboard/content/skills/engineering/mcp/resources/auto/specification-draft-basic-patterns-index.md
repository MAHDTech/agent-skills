+++
title = "specification-draft-basic-patterns-index"
[extra]
skill = false
...
[requests, responses, and notifications](https://modelcontextprotocol.io/specification/draft/basic/index#messages)
into interactions. Every
[transport](https://modelcontextprotocol.io/specification/draft/basic/transports) carries all of these
...
to it, such as
[`notifications/progress`](https://modelcontextprotocol.io/specification/draft/basic/patterns/progress)
and [`notifications/message`](https://modelcontextprotocol.io/specification/draft/server/utilities/logging).
...
[`InputRequiredResult`](https://modelcontextprotocol.io/specification/draft/basic/patterns/mrtr#inputrequiredresult)
