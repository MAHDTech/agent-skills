+++
title = "docs-2026-07-28-learn-architecture"
[extra]
skill = false
...
For more details about server primitives see [server concepts](@/skills/engineering/mcp/resources/auto/docs-2026-07-28-learn-server-concepts.md).
...
For more details about client primitives see [client concepts](@/skills/engineering/mcp/resources/auto/docs-2026-07-28-learn-client-concepts.md).
