+++
title = "docs-draft-tutorials-security-security_best_practices"
[extra]
skill = false
...
MCP is [stateless](https://modelcontextprotocol.io/specification/draft/basic/index#statelessness) and
...
[Authorization Response Validation](https://modelcontextprotocol.io/specification/draft/basic/authorization#authorization-response-validation)
...
See
[Localhost Redirect URI Risks](https://modelcontextprotocol.io/specification/draft/basic/authorization/security-considerations#localhost-redirect-uri-risks)
...
[Trust Policies](https://modelcontextprotocol.io/specification/draft/basic/authorization/security-considerations#trust-policies)
...
\<Note\>
  ...
  **SHOULD** compute the union of previously requested scopes and newly
  ...
  Authorization
  Flow](https://modelcontextprotocol.io/specification/draft/basic/authorization#step-up-authorization-flow).
