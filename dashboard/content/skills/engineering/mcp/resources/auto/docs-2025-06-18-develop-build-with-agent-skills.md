+++
title = "docs-2025-06-18-develop-build-with-agent-skills"
[extra]
skill = false
...
* **User interaction needs** — plain text results, structured input via
  [elicitation](https://modelcontextprotocol.io/specification/2025-06-18/client/elicitation), or rich UI widgets
...
**Remote [Streamable HTTP](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#streamable-http)**
...
[elicitation's](https://modelcontextprotocol.io/specification/2025-06-18/client/elicitation) flat-form constraints
don't fit.
...
**Local [stdio](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio)** remains available
