+++
title = "specification-draft-basic-versioning"
[extra]
skill = false
...
[`_meta`](https://modelcontextprotocol.io/specification/draft/basic/index#meta) field. On HTTP, this is
also carried in the
[`MCP-Protocol-Version` header](https://modelcontextprotocol.io/specification/draft/basic/transports/streamable-http#protocol-version-header).
...
[`UnsupportedProtocolVersionError`](https://modelcontextprotocol.io/specification/draft/schema#unsupportedprotocolversionerror)
...
[`server/discover`](https://modelcontextprotocol.io/specification/draft/server/discover). Clients
...
**MUST** follow the [`_meta` key naming rules](https://modelcontextprotocol.io/specification/draft/basic/index#meta),
...
* [stdio](https://modelcontextprotocol.io/specification/draft/basic/transports/stdio#backward-compatibility):
  probe with `server/discover` and fall back on any error that is not a
  recognized modern error.
* [Streamable HTTP](https://modelcontextprotocol.io/specification/draft/basic/transports/streamable-http#backward-compatibility):
