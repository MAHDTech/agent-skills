+++
title = "docs-draft-develop-clients-client-best-practices"
[extra]
skill = false
...
specification's [caching utility](https://modelcontextprotocol.io/specification/draft/server/utilities/caching). In particular,
...
[`isError: true`](https://modelcontextprotocol.io/specification/draft/server/tools#error-handling) rather than a transport
