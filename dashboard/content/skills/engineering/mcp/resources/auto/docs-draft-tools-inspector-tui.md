+++
title = "docs-draft-tools-inspector-tui"
[extra]
skill = false
...
With neither `--catalog` nor `--config`, and no [ad-hoc target](https://modelcontextprotocol.io/docs/draft/tools/inspector/configuration#ad-hoc-targets), it uses the default writable catalog `~/.mcp-inspector/mcp.json`. See [Configuration and flags](https://modelcontextprotocol.io/docs/draft/tools/inspector/configuration).
...
See [Authorization](https://modelcontextprotocol.io/docs/draft/tools/inspector/authorization) for the full picture.
...
The TUI needs a real TTY with raw-mode support. It will not run usefully in a headless CI job; use the [CLI](https://modelcontextprotocol.io/docs/draft/tools/inspector/cli) there.
