+++
title = "community-working-groups-filesystems"
[extra]
skill = false
...
that behave like a filesystem"](https://modelcontextprotocol.io/specification/draft/server/resources#common-uri-schemes). Currently, Resources carries
