...
1.  Create a SpacetimeAuth project and configure a client as described
    in the [Getting
    Started](/docs/core-concepts/authentication/spacetimeauth/creating-a-project)
    and
    [Configuration](/docs/core-concepts/authentication/spacetimeauth/configuring-a-project)
    guides.
