...
SpacetimeDB module and Svelte client.

This will start the local SpacetimeDB server, publish your module,
generate TypeScript bindings, and start the Svelte development server.
...
`src/App.svelte` to build your UI.
