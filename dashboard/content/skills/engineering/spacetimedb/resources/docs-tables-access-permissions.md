...
See the [Procedures documentation](/docs/functions/procedures) for more
details on using procedures, including making HTTP requests to external
services.

## Views - Read-Only Access

[Views](/docs/functions/views) receive a `ViewContext` or
...
See the [Views documentation](/docs/functions/views) for more details on
...
the [Views documentation](/docs/functions/views) for details.
...
documentation](/docs/clients/subscriptions) for details on client-side
table access.
