...
Tables can trigger [reducers](/docs/functions/reducers) or
[procedures](/docs/functions/procedures) at specific times by including
...
Procedures](/docs/functions/reducers#scheduling-procedures) for an
example.
...
- Learn about [Reducers](/docs/functions/reducers) to handle scheduled
  actions
- Explore [Procedures](/docs/functions/procedures) for scheduled
  execution patterns
