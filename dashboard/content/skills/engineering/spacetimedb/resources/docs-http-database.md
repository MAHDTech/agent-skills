...
by [the SpacetimeDB client SDKs](/docs/clients).
...
[BSATN](/docs/bsatn). Its messages are defined
...
messages according to the [SATS-JSON format](/docs/sats-json).
