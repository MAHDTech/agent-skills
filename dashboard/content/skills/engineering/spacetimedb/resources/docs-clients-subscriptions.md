...
[TypeScript](/docs/clients/typescript#query-builder-api),
[C#](/docs/clients/c-sharp#query-builder-api), and
[Rust](/docs/clients/rust#query-builder-api) references.
...
docs](/docs/reference/sql#subscriptions).
...
- [TypeScript subscription
  API](/docs/clients/typescript#subscribe-to-queries)
- [TypeScript query builder
  API](/docs/clients/typescript#query-builder-api)
...
Practices](/docs/reference/sql#best-practices-for-performance-and-scalability).
