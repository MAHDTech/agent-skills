+++
title = "docs-databases-transactions-atomicity"
[extra]
skill = false
...
operations. Every [reducer](https://spacetimedb.com/docs/functions/reducers) runs inside a
...
transaction. [Procedures](https://spacetimedb.com/docs/functions/procedures) can manually open
...
reducers](https://spacetimedb.com/docs/tables/schedule-tables) instead.

### Procedures: Manual Transactions

Unlike reducers, [procedures](https://spacetimedb.com/docs/functions/procedures) don't
...
See [Procedures](https://spacetimedb.com/docs/functions/procedures) for more details on manual
...
transactions, use [scheduled reducers](https://spacetimedb.com/docs/tables/schedule-tables) to
...
- See [Auto-Increment](https://spacetimedb.com/docs/tables/auto-increment#crash-recovery) for
  details

## Related Topics

- **[Reducers](https://spacetimedb.com/docs/functions/reducers)** - Functions that modify
  database state transactionally
- **[Procedures](https://spacetimedb.com/docs/functions/procedures)** - Functions with manual
  transaction control
