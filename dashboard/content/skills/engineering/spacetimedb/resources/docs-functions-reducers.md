...
multi-column indexes, see [Indexes](/docs/tables/indexes).
...
[Procedures](/docs/functions/procedures) instead. Procedures can make
...
table](/docs/tables/schedule-tables):
...
See [Schedule Tables](/docs/tables/schedule-tables) for more scheduling
options.

## Next Steps

- Learn about [Tables](/docs/tables) to understand data storage
- Explore [Procedures](/docs/functions/procedures) for side effects
  beyond the database
