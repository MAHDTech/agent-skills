+++
title = "developers-tools-function-calling"
[extra]
skill = false
...
if response.tool_calls:
    ...
    for tool_call in response.tool_calls:
        ...
        result = tools_map[name](https://docs.x.ai/developers/tools/**args)
        chat.append(tool_result(json.dumps(result)))
...
for tool_call in response.tool_calls:
    result = tools_map[tool_call.function.name](https://docs.x.ai/developers/tools/**json.loads(tool_call.function.arguments))
    # Append each result...
```
