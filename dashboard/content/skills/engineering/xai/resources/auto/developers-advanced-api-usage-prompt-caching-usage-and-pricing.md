+++
title = "developers-advanced-api-usage-prompt-caching-usage-and-pricing"
[extra]
skill = false
...
Cached tokens are billed at the **cached prompt token price**, which is substantially lower than the regular prompt token price. The exact rates vary by model — check the [Pricing](https://docs.x.ai/developers/pricing) page for current prices.
