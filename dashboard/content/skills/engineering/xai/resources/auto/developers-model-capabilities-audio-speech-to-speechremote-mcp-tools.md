+++
title = "developers-model-capabilities-audio-speech-to-speechremote-mcp-tools"
[extra]
skill = false
...
async def handle_function_call(ws, event):
    ...
    if function_name in FUNCTION_HANDLERS:
        result = FUNCTION_HANDLERS[function_name](https://docs.x.ai/developers/model-capabilities/audio/**arguments)
