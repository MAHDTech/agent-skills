+++
title = "developers-advanced-api-usage-batch-apijsonl-file-upload"
[extra]
skill = false
...
> Model support
>
> `grok-4.5` is not currently supported for Batch API requests and will be rejected.
...
| **Cost** | Standard pricing | Reduced pricing ([see details](https://docs.x.ai/developers/pricing#batch-api-pricing)) |
...
Each batch tracks the total processing cost. Access the cost breakdown after processing to understand your spending. For pricing details, see [Batch API Pricing on the Pricing page](https://docs.x.ai/developers/pricing#batch-api-pricing).
...
Each line in the file is a JSON object with four fields: `custom_id` (unique identifier, maps to `batch_request_id`), `method` (always `"POST"`), `url` (API endpoint path), and `body` (the JSON request payload matching the [REST API reference](https://docs.x.ai/developers/rest-api-reference) for that endpoint).
...
| URL | Description |
|---|---|
| `/v1/chat/completions` | [Chat completions](https://docs.x.ai/developers/model-capabilities/text/generate-text) |
| `/v1/responses` | [Model responses](https://docs.x.ai/developers/model-capabilities/text/generate-text) |
| `/v1/images/generations` | [Image generation](https://docs.x.ai/developers/model-capabilities/images/generation) |
| `/v1/images/edits` | [Image editing](https://docs.x.ai/developers/model-capabilities/images/editing) |
| `/v1/videos/generations` or `/v1/videos` | [Video generation](https://docs.x.ai/developers/model-capabilities/video/generation) |
...
Both [server-side tools](https://docs.x.ai/developers/tools/overview) and client-side function tools are supported in batch requests.
...
* [API Reference: Batch endpoints](https://docs.x.ai/developers/rest-api-reference/inference/batches#create-a-new-batch)
