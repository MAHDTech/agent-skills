+++
title = "developers-rest-api-reference-inference-legacy"
[extra]
skill = false
...
> [!WARNING]
>
> **Deprecated**: The Anthropic SDK compatibility is fully deprecated. Please migrate to the [Responses API](https://docs.x.ai/developers/rest-api-reference/inference/chat#create-new-response) or [gRPC](https://docs.x.ai/developers/grpc-api-reference).
