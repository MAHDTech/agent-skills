+++
title = "developers-rest-api-reference-inference-chatget-deferred-chat-completions"
[extra]
skill = false
...
* `output` (array\<object | object | object | object | object | object | object | object | object | object>, required) — The response generated by the model.
...
* `tools` (array\<object | object | object | object | object | object | object | object>, required) — A list of tools the model may call in JSON-schema. Currently, only functions and web search are supported as tools. A max of 128 tools are supported.
