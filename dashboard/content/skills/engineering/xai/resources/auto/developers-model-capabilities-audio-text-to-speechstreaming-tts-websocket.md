+++
title = "developers-model-capabilities-audio-text-to-speechstreaming-tts-websocket"
[extra]
skill = false
...
You can also list voices programmatically with the [Text to speech - List voices](https://docs.x.ai/developers/rest-api-reference/inference/voice#text-to-speech---list-voices) endpoint:
