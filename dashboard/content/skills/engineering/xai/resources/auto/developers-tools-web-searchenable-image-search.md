+++
title = "developers-tools-web-searchenable-image-search"
[extra]
skill = false
...
Setting `enable_image_search` to true lets Grok search for relevant images and include them in the response as Markdown image embeds such as `![alt](https://docs.x.ai/developers/tools/url)`.
