+++
title = "developers-model-capabilities-text-multi-agent"
[extra]
skill = false
...
xAI provides a set of built-in tools you can enable in the request to help with the most common use cases, e.g., `web_search`, `x_search`, `code_execution`, `collections_search`. Check out [this doc](https://docs.x.ai/developers/tools/overview) for more information.
...
> [!NOTE]
>
> Using built-in tools will incur an additional cost. Please review the [pricing details for built-in tools](https://docs.x.ai/developers/pricing#tools-pricing).
...
For the full multi-turn conversation pattern with reusable functions and code examples, see [Chaining the conversation](https://docs.x.ai/developers/model-capabilities/text/generate-text#chaining-the-conversation).
...
For detailed pricing information, see the [Pricing](https://docs.x.ai/developers/pricing) page and the [Tool Pricing](https://docs.x.ai/developers/pricing#tools-pricing) page.
