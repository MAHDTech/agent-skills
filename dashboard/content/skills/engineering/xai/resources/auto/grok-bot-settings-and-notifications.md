+++
title = "grok-bot-settings-and-notifications"
[extra]
skill = false
...
See [Approvals, security, and privacy](https://docs.x.ai/grok-bot/approvals-security-and-privacy) before
...
See [Use the computer and apps](https://docs.x.ai/grok-bot/computer-and-apps) for the connection flow.
...
[Troubleshooting](https://docs.x.ai/grok-bot/troubleshooting) for the safest recovery order.
