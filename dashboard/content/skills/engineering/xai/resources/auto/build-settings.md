...
For MCP servers, see [MCP Servers](https://docs.x.ai/build/features/mcp-servers). For marketplaces, skills, and plugins, see [Skills, Plugins, and Marketplaces](https://docs.x.ai/build/features/skills-plugins-marketplaces); for hooks, see [Hooks](https://docs.x.ai/build/features/hooks).
...
For the full list of `config.toml` keys, see [TOML Values](https://docs.x.ai/build/settings/reference#toml-values).

## Environment variables

For the full list of environment variables, see [Environment variables](https://docs.x.ai/build/settings/reference#environment-variables).
