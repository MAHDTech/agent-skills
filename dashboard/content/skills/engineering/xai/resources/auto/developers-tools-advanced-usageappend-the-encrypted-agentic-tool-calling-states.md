+++
title = "developers-tools-advanced-usageappend-the-encrypted-agentic-tool-calling-states"
[extra]
skill = false
...
1. Define your client-side tools using [standard function calling patterns](https://docs.x.ai/developers/tools/function-calling)
...
When using [the `max_turns` parameter](https://docs.x.ai/developers/tools/tool-usage-details#limiting-tool-call-turns) with mixed server-side and client-side tools, it's important to understand that **`max_turns` only limits the assistant/server-side tool call turns within a single request**.
...
For more details, check [Identifying Tool Call Types](https://docs.x.ai/developers/tools/tool-usage-details#identifying-tool-call-types).
...
For more details, see [Identifying Tool Call Types](https://docs.x.ai/developers/tools/tool-usage-details#identifying-tool-call-types).
...
For more details about stateful responses, please check out [this guide](https://docs.x.ai/developers/model-capabilities/text/generate-text).
