+++
title = "developers-model-capabilities-text-structured-outputs"
[extra]
skill = false
...
> [!NOTE]
>
> Tool schemas follow the same JSON Schema support rules described on this page. See the [Function Calling](https://docs.x.ai/developers/tools/function-calling) documentation for full details.
