+++
title = "developers-model-capabilities-video-generation"
[extra]
skill = false
...
* [Video Extension](https://docs.x.ai/developers/model-capabilities/video/extension) — Continue an existing video from its last frame.
...
* [Models](https://docs.x.ai/developers/models) — Available video models and pricing
* [Image-to-Video](https://docs.x.ai/developers/model-capabilities/video/image-to-video) — Animate a still image
