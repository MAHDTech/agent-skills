+++
title = "developers-tools-collections-search"
[extra]
skill = false
...
For an introduction to Collections, please check out the [Collections documentation](https://docs.x.ai/developers/files/collections).
