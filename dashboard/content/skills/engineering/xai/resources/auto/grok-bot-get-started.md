...
[set up and use Grok Bot for iOS](https://docs.x.ai/grok-bot/mobile).
...
[create a routine](https://docs.x.ai/grok-bot/skills-routines-and-automations).

## Next steps

* [Create and manage more Bots](https://docs.x.ai/grok-bot/bots)
