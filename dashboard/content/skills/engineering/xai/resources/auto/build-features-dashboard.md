+++
title = "build-features-dashboard"
[extra]
skill = false
...
The input bar at the bottom dispatches prompts to new sessions. `Ctrl+L` changes the working directory for new agents, and `Ctrl+W` toggles whether they start in a [git worktree](https://docs.x.ai/build/features/worktrees).
